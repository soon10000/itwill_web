...
//	@Test
	public void testSave() {
		...
		Post entity = Post.builder().title("JPA 저장 테스트").content("Spring Boot + JPA 저장 테스트").author("admin").build();
		log.info("save 전: {}", entity);
		
		// insert 쿼리 실행: 엔터티 객체의 @Id 설정된 필드가 null인 경우 insert 쿼리문이 실행
