...
@Service
// Spring Security에서 로그인/로그아웃 처리에서 사용 할 수 있도록 하기 위해서
...
public class MemberService implements UserDetailsService { 
	...
	public Member create(MemberSignUpDto dto) {
		...
		// save() -> (1) insert into member, (2) insert int member_roles
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(entity.isPresent()) {
			...
			throw new UsernameNotFoundException(username + " 아이디를 찾을 수 없습니다.");
		}
	}
