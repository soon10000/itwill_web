...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 비밀번호 입력 필드의 change 이벤트 리스너 // 체인지 이벤트 리스너를 만들고 2개의 필드값이 같으면 true / 아니면 false로 나오게 하면 비밀번호 확인 기능이 가능하다.
