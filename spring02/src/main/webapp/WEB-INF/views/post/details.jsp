...
<body>
    <div class="container-fluid">
        ...
        <section>
            <div class="mt-2 card">
                <div clas="card-header d-inline-flex gap-1">
                    <!-- 댓글 접기/펼치기 기능 버튼 -->
                    <button class="btn btn-secondary"
                        id="btnToggleComment">댓글 보기</button>
                </div>
                <!-- 댓글 토글 버튼에 의해서 접기/편치기를 할 영역 -->
                        ...
                        <div class="mt-2 row">
                            <div class="col-10">
                                ...
                                <textarea class="form-control" rows="3"
                                    id="ctext" placeholder="댓글을 작성해주세요."></textarea>
                                <!-- 댓글 작성자 아이디: TODO: 로그인한  -->
                                <input class="form-control"
                                    id="username" placeholder="댓글 작성자" />
                            </div>
        ...
        <!-- 댓글 업데이트 모달(다이얼로그) -->
        <div id="commentModal" class="modal" tabindex="-1"> <!-- tabindex=-1은 z축을 마이너스로 지정하여 화면 가장 아래쪽에 배치하도록 -->
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btnUpdateComment" type="button" class="btn btn-outline-primary">완료</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Axios JS 라이브러리(Axios라이브러리를 사용하기 위해서는 사용할 JS파일 보다 먼저 라이브러리 등록이 되어 있어야한다.) -->
