 ...
 */
 ...
 // button#btn1인 요소를 찾음:
 const btn1 = document.querySelector('button#btn1'); //querySelector의 경우 
 
 // btn 1번 요소에 클릭 이벤트 리스너를 설정:
 ...
 btn2.addEventListener('click', function(){
    ...
    const divs = document.getElementsByClassName('c1'); // -> HTMLCollenction(배열과 비슷)을 리턴
    //console.log(divs);
...
//  tagname, #id, .classname, tag#id.classname
//  parent > child
//  ancestor descendent
